    ...
    def post(self, request, *args, **kwargs):
        ...
        if appointment_id:
            ...
            if appointment:
                ...
                doctor_profile = DoctorProfile.objects.filter(user_id=doctor.id).first()
                print(doctor_profile.service_charge,"do profile")
                # Check if the doctor_profile and service_charge exist
                if doctor_profile:
                    payment_amount = doctor_profile.service_charge
                else:
